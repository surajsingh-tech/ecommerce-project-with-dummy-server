...
export default function AdminProductCreatePage() {
  ...
  let [errorMsg, setErrorMsg] = useState({
    ...
    stockQuantity: "StockQuantity is Mandatory",
  ...
  const getInputData = (e) => {
    ...
    switch (name) {
      case "name":
        ...
        break;
      case "pic":
        value = e.target.files && [...e.target.files].map((pic) => pic.name);
        break;
  ...
  //For Rich Text Editor(For Discription)
  useEffect(() => {
          ...
          <div className="row ">
            ...
            <div className="col-md-9">
              ...
              <form onSubmit={(e) => postData(e)}>
                ...
                <label className="mb-2 text-dark d-block mt-3">
                  Enter Discription*
                </label>
                <div className="form-control border-dark mb-3 mt-2">
                  <div ref={refdiv}></div>
                </div>
